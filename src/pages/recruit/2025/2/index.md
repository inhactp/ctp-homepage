...
8/12부터 상시로 가입 신청이 가능합니다.  
학년, 나이, 전공, 타 동아리 제한 없습니다.  
문제해결에 열정만 가득하시면 됩니다 :)

신규 가입을 원하는 분께서는 아래 링크를 통해 설문에 응답해주시면 됩니다. (면접은 따로 없습니다)
이번에는 추가로 운영진 모집까지 함께 진행하고 있습니다.
https://forms.gle/4UAk1nZjWzQhT4Dd8

가입 신청이 확인되면 8/25, 8/28 이후 일괄적으로 카톡 공지방에 초대해 드릴 예정이며, 9/1 이후 가입 신청한 회원의 경우 설문에 응답해주신 뒤 문의해주시면 공지방에 초대해드리겠습니다.
...
A. 현재 강의 인원이 충분하지 않아, 기초반 없이 질문방만 운영 중입니다. 9월 중에 회비 환불 기간이 있으니, CTP에 가입하신 후 고민하셔도 됩니다.
